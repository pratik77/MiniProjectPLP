...
<body>
	<form name="form" method="post" action="composerSongAssoc.obj"
		...
		<br> <input type="submit" id="Associate1" name="Associate"
			value="Associate"><br> <input type="submit"
			id="Associate2" name="Associate" value="Get All Songs"><br>
		Click on the radio button to select composer and select check boxes to
		associate multiple songs to the composer <br> <a
			href="ui/admin.jsp">Return to admin home page</a><br>
		<br> <a href="ui/login.jsp">Logout</a>
	</form>
	<%-- <br><h3>${message }</h3> --%>
</body>
</html>